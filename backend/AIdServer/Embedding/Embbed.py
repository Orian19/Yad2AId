import sqlite3
import numpy as np
from ..utils.db_utils import adapt_array, convert_array
...
def create_connection():
    ...
    con = sqlite3.connect("apartmentsAId.db", detect_types=sqlite3.PARSE_DECLTYPES)
    cur = con.cursor()

    return con, cur


def get_apt_images(cur):
    # todo: complete
    pass


def insert_embeddings(cur, con, embeddings):
    # todo: complete
    embedding = embeddings[0]
    cur.execute("""INSERT INTO Apartments (Embedding) VALUES (?)""", (
        embedding,
    ))
